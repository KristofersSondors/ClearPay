      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <TextInput style={styles.input} placeholder="••••••••" placeholderTextColor="#aaa" value={currentPw} onChangeText={setCurrentPw} secureTextEntry />
            <Text style={styles.fieldLabel}>New Password</Text>
            <TextInput style={styles.input} placeholder="••••••••" placeholderTextColor="#aaa" value={newPw} onChangeText={setNewPw} secureTextEntry />
            <Text style={styles.fieldLabel}>Confirm New Password</Text>
            <TextInput style={styles.input} placeholder="••••••••" placeholderTextColor="#aaa" value={confirmPw} onChangeText={setConfirmPw} secureTextEntry />
...
const styles = StyleSheet.create({
  ...
  backLink: { color: '#5B3FD9', fontSize: 14, marginBottom: 16, fontWeight: '500' },
  card: {
  ...
  avatar: {
    width: 80, height: 80, borderRadius: 40, backgroundColor: '#E5E5E5',
    justifyContent: 'center', alignItems: 'center', marginBottom: 8, overflow: 'hidden',
  },
  uploadText: { color: '#5B3FD9', fontSize: 13, fontWeight: '500' },
  sectionLabel: { fontSize: 12, fontWeight: '700', color: '#888', marginBottom: 8, marginTop: 16, letterSpacing: 0.5 },
