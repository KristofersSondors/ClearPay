        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.amountRow}>
              ...
              />
              <TouchableOpacity
                style={styles.currSelect}
                onPress={() => setCurrOpen(!currOpen)}
              >
            ...
            {currOpen && (
              <View
                style={[styles.dropdown, { alignSelf: "flex-end", width: 100 }]}
              >
                {CURRENCIES.map((c) => (
                  <TouchableOpacity
                    key={c}
                  ...
                  >
                    <Text
                      style={[
                        styles.dropText,
                        currency === c && styles.dropTextActive,
                      ]}
                    >
                      {c}
                    </Text>
