        ...
        {[
          ...
          <TouchableOpacity key={item.label} style={styles.prefRow}>
            ...
            <View style={{ flex: 1, alignItems: 'flex-end' }}>
              {item.value ? <Text style={styles.prefValue}>{item.value}</Text> : null}
            </View>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    width: 56, height: 56, borderRadius: 28, backgroundColor: '#E5E5E5',
  ...
  planBadge: {
    alignSelf: 'flex-start', backgroundColor: '#EEE9FF', borderRadius: 20,
  ...
  sectionLabel: { fontSize: 14, fontWeight: '600', color: '#888', marginBottom: 8, marginTop: 4 },
  bankDesc: { fontSize: 12, color: '#888', marginBottom: 12, lineHeight: 18 },
  bankRow: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    borderWidth: 1.5, borderColor: '#E5E5E5', borderRadius: 10, padding: 14, marginBottom: 8,
  },
  ...
  connectedBadge: { backgroundColor: '#DCFCE7', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  connectedText: { color: '#16A34A', fontSize: 13, fontWeight: '600' },
  prefRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: '#F5F5F5' },
