  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.message}>You have successfully canceled your subscription!</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    padding: 36, alignItems: 'center', marginBottom: 28, width: '100%',
  },
  message: { fontSize: 20, fontWeight: '600', textAlign: 'center', color: '#1a1a1a', lineHeight: 28 },
  btn: {
    backgroundColor: '#5B3FD9', borderRadius: 50,
