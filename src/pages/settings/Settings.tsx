...
export function Settings() {
  return (
    <div className="px-4 py-6 space-y-6">
      ...
      <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="font-bold text-gray-900">Alex Design</h2>
      ...
      <button className="w-full py-3 rounded-xl bg-red-500 text-white font-medium flex items-center justify-center gap-2 hover:bg-red-600 transition-colors">
